...
class Installer extends Base\Installer
{
    ...
    public function __construct()
    {
        ...
        $this->options = array(
            ...
            'bookly_sms_unverified_token'                => '',
            'bookly_sms_unverified_username'             => '',
            // Business hours.
    ...
    public function createTables()
    {
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Entities\Service::getTableName() . '` (
                ...
                `online_meetings`              ENUM("off","zoom") NOT NULL DEFAULT "off",
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Entities\Appointment::getTableName() . '` (
                ...
                `online_meeting_provider`  ENUM("zoom") DEFAULT NULL,
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Entities\Payment::getTableName() . '` (
                ...
                `type`      ENUM("local","free","paypal","authorize_net","stripe","2checkout","payu_biz","payu_latam","payson","mollie","woocommerce") NOT NULL DEFAULT "local",
